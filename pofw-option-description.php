<?php
/**
 * Plugin Name: POFW Option Description 
 * Description: Adds descriptions to product options of the "Product Options for WooCommerce" plugin.
 * Version: 1.0.0
 * Author: Pektsekye
 ...
 * Tested up to: 6.4.3
 *
 * Text Domain: pofw-option-description
 *
 * WC requires at least: 3.0
 * WC tested up to: 8.6.1
 * 
 * @package OptionDescription
 * @author Pektsekye
 */
if (!defined('ABSPATH')) exit;

final class Pektsekye_OptionDescription {
  ...
  private function init_hooks(){ 
    new Pektsekye_OptionDescription_Model_Observer();           
  }    
  ...
  private function init_controllers(){
      ...
      new Pektsekye_OptionDescription_Controller_Product();    	
      ...
      if ((isset($_GET['post']) && isset($_GET['action']) && $_GET['action'] == 'edit') || ('post-new.php' == $pagenow && isset($_GET['post_type']) && $_GET['post_type'] == 'product')){         
        ...
        new Pektsekye_OptionDescription_Controller_Adminhtml_Product();                    
      }                
    }     	  
  }  
...
function Pektsekye_ODS(){
	return Pektsekye_OptionDescription::instance();
}

include_once('Setup/Install.php');  
register_activation_hook(__FILE__, array('Pektsekye_OptionDescription_Setup_Install', 'install'));
